 ...
 */
import type { TeamTrackerRoomId, SyncId, TrackerMutationRejectCode } from '@nimbalyst/collab-protocol';
export type { SyncId, TrackerItemEnvelope, TrackerRoomConfig, TrackerMutationRejectCode, TrackerClientMessage, TrackerServerMessage, TrackerSchemaEnvelope, TrackerNavigationEnvelope, TrackerSavedViewEnvelope, TrackerSyncRequestMessage, TrackerMutationRequestMessage, TrackerMutationBatchRequestMessage, TrackerSetConfigMessage, TrackerPingMessage, TrackerSchemaSyncRequestMessage, TrackerSchemaMutationRequestMessage, TrackerNavigationSyncRequestMessage, TrackerNavigationMutationRequestMessage, TrackerSavedViewSyncRequestMessage, TrackerSavedViewMutationRequestMessage, TrackerPresenceMessage, TrackerSyncResponseMessage, TrackerDeltaMessage, TrackerMutationAckMessage, TrackerMutationBatchAckMessage, TrackerConfigBroadcastMessage, TrackerSchemaSyncResponseMessage, TrackerSchemaDeltaMessage, TrackerSchemaMutationAckMessage, TrackerNavigationSyncResponseMessage, TrackerNavigationDeltaMessage, TrackerNavigationMutationAckMessage, TrackerSavedViewSyncResponseMessage, TrackerSavedViewDeltaMessage, TrackerSavedViewMutationAckMessage, TrackerPresenceRosterMessage, TrackerPresenceDeltaMessage, TrackerPresenceMember, TrackerPongMessage, TrackerRoomMovedMessage, TrackerErrorMessage, } from '@nimbalyst/collab-protocol';
 ...
 */
export declare function buildTrackerRoomId(orgId: string, teamProjectId: TeamProjectId): TrackerRoomId;
/**
 ...
 */
export declare const LOCAL_ONLY_PAYLOAD_FIELDS: readonly ["linkedSessions"];
/**
 ...
 *                       back by the engine.
 */
export type TrackerTransactionState = 'pendingApply' | 'created' | 'queued' | 'executing' | 'persistedEnqueue';
/**
 ...
 */
export declare function stripLocalOnlyFields(payload: TrackerItemPayload): TrackerItemPayload;
