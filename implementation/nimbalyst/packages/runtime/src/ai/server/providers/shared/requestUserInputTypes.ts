...
import type {
  ...
  StructuredInputBaseField,
  StructuredInputConfirmField,
  StructuredInputEditTextField,
  StructuredInputField,
  StructuredInputMultiSelectField,
  StructuredInputMultiSelectItem,
  StructuredInputReorderField,
  StructuredInputReorderItem,
  StructuredInputSingleSelectField,
