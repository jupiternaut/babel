...
2026-09-16 已在 Mac 新检出并完成原生开发验证：安装、共享模块/worker 构建、浅深主题、菜单、材质回退及 GUI/CLI/POSIX PTY 生命周期；首轮单测失败已在后续修复。最新门禁与未测范围见 [实施证据](TASK_EVIDENCE.md)，开发完成与验收通过分别记在 [TASKS](TASKS.md)，不据局部通过宣布发布验收完成。
